...
export default function AccorHotels() {
    ...
    return (
        <CanvasItem top="1100px" left="2000px" scrollSpeed={13} className={classes.item} onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)}>
        ...
        <Typography className={classes.titleItem} style={isHover ? { fontSize: "50px", top: "230px", left: "200px" } : { top: "250px", left: "300px" }}>AccorHotels</Typography>
        </CanvasItem >
    )
}
