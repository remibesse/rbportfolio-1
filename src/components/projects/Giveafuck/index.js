...
export default function Giveafuck() {
    ...
    return (
        <CanvasItem top="580px" left="1350px" scrollSpeed={13} className={classes.item}  onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)}>
            ...
            <Typography className={classes.title} style={isHover ? { fontSize: "50px", top: "250px", left: "30px" } : { top: "300px", left: "24px" }}>Give</Typography>
            <Typography className={classes.title} style={isHover ? { fontSize: "50px", top: "300px", left: "31px" } : { top: "327px", left: "25px" }}>a fuck</Typography>
        </CanvasItem>
    )
}
